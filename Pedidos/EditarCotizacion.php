...
<div id="CuerpoTotal">
  <fieldset>
    <legend class="titulo_modal">Cotizaciones Cargadas</legend>

    <div class="row">
      <div class="form-group row col-md-3">
          <label for="EditOrdenPedido_Filt_Dpto" class="col-md-5">Departamento: </label>
          <div class="col-md-7">
             <select class="form-control" id="EditOrdenPedido_Filt_Dpto" title="Filtrar por Departamento" data-toggle="tooltip" onchange="CargarMunicipio2()" name="EditOrdenPedido_Filt_Dpto">
      ...
      <div class="form-group row col-md-3">
          <label for="EditOrdenPedido_Filt_Mpio" class="col-md-5">Municipio: </label>
          <div class="col-md-7">
             <select class="form-control" id="EditOrdenPedido_Filt_Mpio" title="Filtrar por Municipio" data-toggle="tooltip" onchange="CargarContrato2();" name="EditOrdenPedido_Filt_Mpio">
              <option value="Ninguno">Seleccione</option>                  
             </select>
          </div>
      </div>
      <div class="form-group row col-md-4">
          <label for="EditOrdenPedido_Filt_contrato" class="col-md-5">Contrato/Convenio: </label>
          <div class="col-md-6">
             <select class="form-control" id="EditOrdenPedido_Filt_contrato" title="Filtrar por Contrato / Convenio" data-toggle="tooltip" name="EditOrdenPedido_Filt_contrato">
              <option value="Ninguno">Seleccione</option>                  
             </select>
          </div>
      </div>
    ...
    <div class="row" style="margin-left:0px;">
      <div class="form-group row col-md-3">
          <label for="EditOrdenPedido_Filt_fechaIni" class="col-md-5" style="padding: 0px;">Fecha de Inicio</label>
          <div class="col-md-7">
              <input type="date" class="form-control form-control-plaintext" title="Filtrar por Rango de fecha" data-toggle="tooltip"  autocomplete="off" id="EditOrdenPedido_Filt_fechaIni" name="EditOrdenPedido_Filt_fechaIni" required>
          </div>
      </div>
      <div class="form-group row col-md-3">
          <label for="EditOrdenPedido_Filt_fechaFin" class="col-md-5" style="padding: 0px;">Fecha de Fin</label>
          <div class="col-md-7">
              <input type="date" class="form-control form-control-plaintext" title="Filtrar por Rango de fecha" data-toggle="tooltip" autocomplete="off" id="EditOrdenPedido_Filt_fechaFin" name="EditOrdenPedido_Filt_fechaFin" required>
          </div>
      </div>
      <div class="col-md-3">
          <div class="col-md-7">
              <button class="btn btn-success" onclick="CargarListadoOrdenProveedores()">Filtrar</button>
          </div>
      </div>
    </div>
...
<br>
    ...
    <br>
    <table class="table table-striped" id="tbl_ListadoOrdenPedido">
      <thead>
        <tr>
          <th>#</th>
...
<div id="cuerpoEditar" style="display: none;">
<fieldset>
  <legend class="titulo_modal">Datos Básicos</legend>
    <div class="row">
      ...
      <div class="form-group row col-md-4">
          ...
          <div class="col-md-6">
             <select class="form-control" id="GenOrdenPedido_contrato" name="GenOrdenPedido_contrato">
              <option value="Ninguno">Seleccione</option>                  
             </select>
          </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="form-group row col-md-3">
           <button class="btn btn-success" onclick="GuardarActualizarOrdenPedido()">Actualizar Cotización</button>
      </div>
      <div class="form-group row col-md-3">
           <button class="btn btn-success" onclick="RegresarOrdenPedido()">Regresar al Listado</button>
      </div>
    </div>
</fieldset>
...
<fieldset style="margin-top:30px;">
  <legend class="titulo_modal">Materiales de la Cotización<button class="btn_transparente" onclick="$('#btn_modal_AddElement').click();" title="Agregar Elemento a la lista" data-toggle="tooltip"><i class="fa-solid fa-file-circle-plus"></i></button></legend>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row"  style="margin-left:0px !important;">
          ...
          <div class="form-group row col-md-4">
            <label for="ProveedorListaPrecio_Proveedor" class="col-md-5"><span style="color:red">*</span> Proveedor </label>
            <div class="col-md-7">
          ...
          <div class="form-group row col-md-3" style="padding:0px;">
            <label for="GenOrdenPedido_NMaterial" class="col-md-6"><span style="color:red">*</span> Nombre Material: </label>
          ...
          <div class="form-group row col-md-2" style="padding:0px; margin-left: 6px;">
            <label for="GenOrdenPedido_Und" class="col-md-7"><span style="color:red">*</span> Unidad Material: </label>
          ...
          <div class="form-group row col-md-3" style="padding:0px; margin-left: 19px;">
            <label for="GenOrdenPedido_CantMaterial" class="col-md-6"><span style="color:red">*</span> Cantidad Material: </label>
            <div class="col-md-6" style="padding:0px;">
...
$(document).ready(function() {
  ...
  $('#tbl_ListadoOrdenPedido').DataTable({
    "language": {
      "url": "//cdn.datatables.net/plug-ins/1.10.19/i18n/Spanish.json"
    },
    "pageLength": 50,
