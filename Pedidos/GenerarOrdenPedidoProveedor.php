...
<div class="row">
  ...
  <div class="form-group row col-md-3">
    <label for="OPP_Num_Cotizacion" class="col-md-6 titulo_modal"><span style="color:red">*</span> Cotización: </label>
    <div class="col-md-5">
      <input type="text" onkeyup="BuscarCotizacion()" autocomplete="off" name="OPP_Num_Cotizacion" Id="OPP_Num_Cotizacion" class="form-control">
    ...
    <div class="btn_div_Add"> 
      <button onclick="AgregarCotizacionOrdenPedido()" title="Adicionar Cotización" data-toggle="tooltip" data-placement="bottom" class="btn_transparente"><i class="fa-regular fa-square-plus fa-2xs"></i></button>
    </div>
  </div>
</div>
<div class="row">
  ...
  <div class="col-md-4" id="div_saldos_contrato" style="display:none;">
    ...
    <fieldset class="total">
      <legend>Total 1</legend>
      <div class="description"><i class="fa-regular fa-circle-question" style="color: #009540;" data-toggle="tooltip" title="saldo estimado de la orden actual"></i> Saldo Total Orden Actual:</div>
      <div class="amount OrdenActual">$0</div>
    </fieldset>
  </div>
</div>
<br>
<div class="row">
  ...
  <div class="col-md-3 btn_div_Add"> <button id="Btn_Guardar_OrdenPedido" class="btn btn-success" onclick="GenerarOrdenPedidoResumen()">Guardar Orden de Pedido</button> </div>
</div>


<br>
<fieldset style="margin-top:30px;">
  <legend class="titulo_modal">Cotizaciones por el Contrato/Convenio</legend>
...
<br>
<fieldset style="margin-top:30px;display: none;" id="OPP_Flst_Mat_Agg">
  <legend class="titulo_modal">Materiales Cargados</legend>
    <div class="row"> <div class="col-md-12">
    <table class="table table-striped" id="tbl_CotizacionesMaterialesAgregados">
      <thead>
        <th>#</th>
        <th>Proveedor</th>
        <th>Material</th>
