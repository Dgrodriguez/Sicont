...
<div class="row">
  ...
  <div class="form-group row col-md-3">
    <button class="btn btn-success" onclick="FiltrarOrdenesPedido()">Filtrar <i class="fa-solid fa-magnifying-glass fa-2xs"></i></button>
  </div>
  ...
  <div class="modal-dialog modal-lg" role="document" style="width:90%">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title titulo_modal" id="AgregarElementoLabel">Reportar Elemento</h5>
      ...
      <div class="modal-footer justify-content-between">
        ...
        <button class="btn btn-success" id="Btn_AgregarItem" onclick="ReportarElementosOPP()">Aplicar</button>
